...
const PortfolioModels = ({title="title", imgSrc="image", modelNo="portfolioModalNO"}) => (
    <div className="portfolio-modal modal fade" id={modelNo} tabindex="-1" aria-labelledby={modelNo} aria-hidden="true">
                        ...
                        <div className="container">
                            <div className="row justify-content-center">
                                <div className="col-lg-8">
                                    ...
                                    <img className="img-fluid rounded mb-5" src={imgSrc} alt="..." />
